...
namespace wirekrak::core::protocol::kraken::parser::dom {

struct rejection_notice {
    [[nodiscard]]
    static inline MessageResult parse(const simdjson::dom::element& root, schema::rejection::Notice& out) noexcept {
